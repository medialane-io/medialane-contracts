...
use creator_coin::exchanges::ekubo::ekubo_adapter::{EkuboLaunchParameters};
use creator_coin::utils::ContractAddressOrder;
...
mod EkuboLauncher {
    ...
    use creator_coin::exchanges::ekubo::errors::{NOT_POSITION_OWNER};
    use creator_coin::exchanges::ekubo::helpers::{
        get_next_tick_bounds, get_initial_tick_from_starting_price
    };
    use creator_coin::exchanges::ekubo::interfaces::{
        ...
        fn locked(ref self: ContractState, id: u32, data: Array<felt252>) -> Array<felt252> {
            ...
            match consume_callback_data::<CallbackData>(core, data) {
                ...
                CallbackData::LaunchCallback(params) => {
                    ...
                    // The initial_tick must correspond to the wanted initial price in quote/CREATOR_COIN
                    ...
                    let launched_token = ICreatorCoinDispatcher {
