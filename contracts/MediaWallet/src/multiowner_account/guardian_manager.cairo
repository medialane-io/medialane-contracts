...
use media_wallet::signer::signer_signature::{Signer, SignerInfo, SignerSignature, SignerType};
...
pub mod guardian_manager_component {
    ...
    use media_wallet::utils::serialization::full_deserialize;
    use media_wallet::utils::transaction_version::is_estimate_transaction;
    ...
    pub impl GuardianManagerInternal<
        TContractState, +HasComponent<TContractState>, +IEmitMediaWalletEvent<TContractState>, +Drop<TContractState>,
    ...
    > of PrivateTrait<TContractState> {
        ...
        fn emit_signer_linked_event(ref self: ComponentState<TContractState>, event: SignerLinked) {
            ...
            contract.emit_event_callback(MediaWalletEvent::SignerLinked(event));
        }
