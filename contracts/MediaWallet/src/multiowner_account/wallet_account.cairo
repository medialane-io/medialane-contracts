...
pub mod MediaWallet {
    ...
    use media_wallet::session::session::{ISessionCallback, session_component, session_component::InternalTrait};
    ...
    const NAME: felt252 = 'MediaWallet';
    ...
    // Required Callbacks
    impl EmitMediaWalletEventImpl of IEmitMediaWalletEvent<ContractState> {
    ...
    #[abi(embed_v0)]
    impl DeprecatedMediaWalletImpl of IDeprecatedMediaWallet<ContractState> {
