...
use media_wallet::multiowner_account::recovery::Escape;
...
#[starknet::interface]
pub trait ITestMediaWallet<TContractState> {
    // IAccount
...
pub fn initialize_account() -> ITestMediaWalletDispatcher {
    initialize_account_with(OWNER().pubkey, GUARDIAN().pubkey)
}

pub fn initialize_account_without_guardian() -> ITestMediaWalletDispatcher {
    initialize_account_with(OWNER().pubkey, 0)
}

pub fn initialize_account_with(owner: felt252, guardian: felt252) -> ITestMediaWalletDispatcher {
