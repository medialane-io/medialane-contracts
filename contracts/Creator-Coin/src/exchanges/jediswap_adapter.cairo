...
impl JediswapAdapterImpl of creator_coin::exchanges::ExchangeAdapter<
...
> {
    fn create_and_add_liquidity(
        ...
        let creator_coin_address = creator_coin.contract_address;
        ...
        // Add liquidity - approve the supplied LP of the creator_coin and quote token balances
        ...
        creator_coin.approve(jedi_router.contract_address, lp_supply);
        ...
        let (amount_creator_coin, amount_eth, liquidity_received) = jedi_router
            .add_liquidity(
        ...
        let pair_address = jedi_factory.get_pair(creator_coin_address, quote_address);
