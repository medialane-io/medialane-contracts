...
use creator_coin::locker::{errors, LockManager, ILockManagerDispatcher, ILockManagerDispatcherTrait};
...
mod test_internals {
    ...
    use creator_coin::locker::lock_manager::LockManager::token_locksContractMemberStateTrait;
    #[test]
...
mod test_withdrawal {
    ...
    use creator_coin::locker::{LockPosition, TokenLock};
    use creator_coin::tests::unit_tests::utils::{ETH_INITIAL_SUPPLY, DEFAULT_INITIAL_SUPPLY};
...
mod test_transfer_lock {
    ...
    use creator_coin::locker::TokenLock;
