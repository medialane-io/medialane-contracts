...
use crate::{
    Felt252TryIntoStarknetSigner, GUARDIAN, ITestMediaWalletDispatcherTrait, OWNER, TX_HASH, WRONG_GUARDIAN,
...
impl SignatureCheckerTrait of ISignatureCheckerTrait {
    fn check_signature(self: @ITestMediaWalletDispatcher, hash: felt252, signature: Array<felt252>) -> bool {
        let safe_dispatcher = ITestMediaWalletSafeDispatcher { contract_address: *self.contract_address };
