...
pub mod upgrade_component {
    use media_wallet::account::SRC5_ACCOUNT_INTERFACE_ID;
    use media_wallet::introspection::{ISRC5DispatcherTrait, ISRC5LibraryDispatcher};
    ...
    use media_wallet::utils::asserts::assert_only_self;
